  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="fp-glass-card border border-fp-border rounded-fp-lg max-w-[860px] w-[85%] max-h-[85vh] animate-slide-up shadow-2xl flex flex-col overflow-hidden"
      >
        {/* ---- Header ---- */}
        <div className="px-3 py-2.5 flex items-center justify-between border-b border-fp-border shrink-0">
          ...
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            {/* Change type pill */}
            <span
              className={`text-[9px] font-bold font-mono py-[2px] px-1.5 rounded-fp-sm tracking-[0.06em] leading-none shrink-0 ${cs.colorClass} ${cs.bgClass}`}
            >
              {cs.label}
            </span>
            ...
            {/* File path */}
            <span
              className="font-mono text-[11px] text-fp-muted overflow-hidden text-ellipsis whitespace-nowrap min-w-0"
              title={path}
            >
              {path}
            </span>
          ...
          <div className="flex items-center gap-1.5 shrink-0 ml-2">
            {/* Language badge */}
            {langLabel && (
              <span className="text-[9px] font-mono text-fp-dim bg-fp-glass py-[2px] px-1.5 rounded-fp-sm font-medium tracking-[0.03em] leading-none">
                {langLabel}
              </span>
            )}
